...
<svg width="495" height="200" viewBox="0 0 495 200" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="GitHub Stats for ${escapeXml(username)}">
  <defs>
    ...
    <!-- Native SVG CSS Styles and Animations inside CDATA to avoid XML entity parse errors -->
    <style><![CDATA[
      .header-title {
      ...
      .stat-val {
        font: 800 21px -apple-system, BlinkMacSystemFont, "Segoe UI", Roboto, Helvetica, Arial, sans-serif;
        fill: ${theme.text};
  ...
  <rect x="0.5" y="0.5" rx="12" width="494" height="199" fill="url(#bgGrad)" stroke="${borderStroke}" stroke-width="1.2" />
  ...
  <!-- Metric 4: PRs and Issues (Bottom-Right) -->
...
<svg width="495" height="200" viewBox="0 0 495 200" fill="none" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Error: ${safeMessage}">
  ...
  <!-- Background Box -->
  <rect x="0.5" y="0.5" rx="12" width="494" height="199" fill="url(#errBgGrad)" stroke="${borderStroke}" stroke-width="1.2" />
